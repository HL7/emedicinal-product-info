...
// ingredients
* entry[+].resource = cfsb1639762372322 // Orange flavour
* entry[+].resource = cfsb1639754408039 // fosfomycin tromotamol
* entry[+].resource = cfsb1639762593730 // Sucrose
* entry[+].resource = cfsb1639762372321 // Saccharin
* entry[+].resource = cfsb1639762372323 // mandarin flavour
