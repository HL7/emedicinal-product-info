Instance: ibranceusppibundleEnglish
InstanceOf: Bundle
Usage: #example
...
* type = #document
* timestamp = "2002-12-02T00:00:00Z"

// Composition
* entry[+].resource = IbrancePPICompositionEnglish

// Organizations
* entry[+].resource = PfizerLaboratoriesDivPfizerInc

// authorizations
* entry[+].resource = ibrancetabletsauth
