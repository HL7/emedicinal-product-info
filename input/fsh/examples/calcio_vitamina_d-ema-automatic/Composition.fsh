...
* section[+].
  ...
  * code.text = "Product Info"
  ...
  // Ingredient
//  * entry[+].fullUrl = ingredient-for-calciovitaminad-calciumcarbonate
  * entry[+] = Reference(ingredient-for-calciovitaminad-calciumcarbonate) 

  // Ingredient
//  * entry[+].fullUrl = ingredient-for-calciovitaminad-cholecalciferol
  * entry[+] = Reference(ingredient-for-calciovitaminad-cholecalciferol) 

  // Ingredient
//  * entry[+].fullUrl = ingredient-for-calciovitaminad-sodium
  * entry[+] = Reference(ingredient-for-calciovitaminad-sodium) 

  // Ingredient
//  * entry[+].fullUrl = ingredient-for-calciovitaminad-lactosemonohydrate
  * entry[+] = Reference(ingredient-for-calciovitaminad-lactosemonohydrate) 

  // Ingredient
//  * entry[+].fullUrl = ingredient-for-calciovitaminad-sucrose
  * entry[+] = Reference(ingredient-for-calciovitaminad-sucrose) 

  // Ingredient
//  * entry[+].fullUrl = ingredient-for-calciovitaminad-hydrogenatedsoybeanoil
  * entry[+] = Reference(ingredient-for-calciovitaminad-hydrogenatedsoybeanoil) 

  // Ingredient
//  * entry[+].fullUrl = ingredient-for-calciovitaminad-anhydrouscitricacid
  * entry[+] = Reference(ingredient-for-calciovitaminad-anhydrouscitricacid) 

  // Ingredient
//  * entry[+].fullUrl = ingredient-for-calciovitaminad-sodiumbicarbonate
  * entry[+] = Reference(ingredient-for-calciovitaminad-sodiumbicarbonate) 

  // Ingredient
//  * entry[+].fullUrl = ingredient-for-calciovitaminad-povidone
  * entry[+] = Reference(ingredient-for-calciovitaminad-povidone) 

  // Ingredient
//  * entry[+].fullUrl = ingredient-for-calciovitaminad-saccharinsodium
  * entry[+] = Reference(ingredient-for-calciovitaminad-saccharinsodium) 

  // Ingredient
//  * entry[+].fullUrl = ingredient-for-calciovitaminad-sodiumcyclamate
  * entry[+] = Reference(ingredient-for-calciovitaminad-sodiumcyclamate) 

  // Ingredient
//  * entry[+].fullUrl = ingredient-for-calciovitaminad-macrogol6000
  * entry[+] = Reference(ingredient-for-calciovitaminad-macrogol6000) 
 

  // Substance
//  * entry[+].fullUrl = substance-calciumcarbonate
