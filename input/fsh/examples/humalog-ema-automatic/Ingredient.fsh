...
* substance.code.concept.coding = $ginas#PDC6A3C0OX "Glycerol"



// Reference to products
* for = Reference(mid-humalog100uml5prefilledpen)
* for[+] = Reference(mpHumalogMix50InsulinKwikPen3mlprefill)
* for[+] = Reference(ap-humalog100uml5prefilledpen)
...
* substance.code.concept.coding = $ginas#QTT17582CB "Hydrochloric acid"
...
* substance.code.concept.coding = $ginas#SOI2LOH54Z "Zinc Oxide"
...
* substance.code.concept.coding = $ginas#023C2WHX2V "Trometamol"
