...
* section[2].title = "4. 効能又は効果"
* section[2].code = https://pmda.jp/#4
* section[2].code.text = "効能又は効果"
* section[2].text.div = "<div xmlns='http://www.w3.org/1999/xhtml'>
閉経後乳癌
</div>"
* section[2].text.status = #additional

* section[3].title = "6. 用法及び用量"
* section[3].code = https://pmda.jp/#6
* section[3].code.text = "用法及び用量"
...
* section[4].title = "8. 重要な基本的注意"
* section[4].code = https://pmda.jp/#8
* section[4].code.text = "重要な基本的注意"
* section[4].text.div = "<div xmlns='http://www.w3.org/1999/xhtml'>
8.1 本剤はホルモン療法剤であり、がんに対する薬物療法について十
 分な知識・経験を持つ医師のもとで、本剤による治療が適切と判断
される患者についてのみ使用すること。
8.2 本剤は末梢アロマターゼを阻害することにより治療効果を発揮す
...
8.4 本剤の使用による嗜眠、傾眠、無力(症)及びめまいが報告され ており、このような症状がある場合、機械操作や自動車の運転はさ せないよう十分注意すること。
</div>"
* section[4].text.status = #additional

* section[5].title = "9. 特定の背景を有する患者に関する注意"
* section[5].code = https://pmda.jp/#9
* section[5].code.text = "特定の背景を有する患者に関する注意"
...
* section[6].title = "10. 相互作用"
* section[6].code = https://pmda.jp/#10
* section[6].code.text = "10. 相互作用"
* section[6].text.div = "<div xmlns='http://www.w3.org/1999/xhtml'>
10.2 併用注意(併用に注意すること)
</div>"
* section[6].text.status = #additional

* section[7].title = "11. 副作用"
* section[7].code = https://pmda.jp/#11
* section[7].code.text = "11. 副作用"
...
* section[8].title = "14. 適用上の注意"
* section[8].code = https://pmda.jp/#14
* section[8].code.text = "14. 適用上の注意"
...
* section[9].title = "15. その他の注意"
* section[9].code = https://pmda.jp/#15
* section[9].code.text = "15. その他の注意"
...
* section[11].title = "16. 薬物動態" // insert image
* section[11].code = https://pmda.jp/#16
* section[11].code.text = "16. 薬物動態"
...
* section[12].title = "17. 臨床成績"
* section[12].code = https://pmda.jp/#17
* section[12].code.text = "17. 臨床成績"
* section[12].text.div = "<div xmlns='http://www.w3.org/1999/xhtml'>
</div>"
* section[12].text.status = #additional

* section[13].title = "17.1 有効性及び安全性に関する試験 "
* section[13].code = https://pmda.jp/#17.1
* section[13].code.text = "17.1 有効性及び安全性に関する試験 "
* section[13].text.div = "<div xmlns='http://www.w3.org/1999/xhtml'>
17.1.1 国内臨床試験
...
* section[14].title = "18. 薬効薬理"
* section[14].code = https://pmda.jp/#18
* section[14].code.text = "18. 薬効薬理"
...
* section[15].title = "19. 有効成分に関する理化学的知見" // insert image
* section[15].code = https://pmda.jp/#19
* section[15].code.text = "19. 有効成分に関する理化学的知見"
...
* section[16].title = "22. 包装"
* section[16].code = https://pmda.jp/#22
* section[16].code.text = "22. 包装"
...
* section[17].title = "23. 主要文献"
* section[17].code = https://pmda.jp/#23
* section[17].code.text = "23. 主要文献"
...
* section[18].title = "24. 文献請求先及び問い合わせ先"
* section[18].code = https://pmda.jp/#24
* section[18].code.text = "24. 文献請求先及び問い合わせ先"
...
* section[19].title = "26. 製造販売業者等" // insert image
* section[19].code = https://pmda.jp/#26
* section[19].code.text = "26. 製造販売業者等"
