...
* entry[+].fullUrl = "Ingredient/ingredient-for-remsima-infliximab"
* entry[=].resource = ingredient-for-remsima-infliximab 

// Ingredient

* entry[+].fullUrl = "Ingredient/ingredient-for-remsima-disodiumphosphatedihydrate"
* entry[=].resource = ingredient-for-remsima-disodiumphosphatedihydrate 

// Ingredient

* entry[+].fullUrl = "Ingredient/ingredient-for-remsima-sodiumdihydrogenphosphatemonohydrate"
* entry[=].resource = ingredient-for-remsima-sodiumdihydrogenphosphatemonohydrate 

// Ingredient

* entry[+].fullUrl = "Ingredient/ingredient-for-remsima-polysorbate80"
* entry[=].resource = ingredient-for-remsima-polysorbate80 

// Ingredient

* entry[+].fullUrl = "Ingredient/ingredient-for-remsima-sucrose"
* entry[=].resource = ingredient-for-remsima-sucrose 
 

// Substance
   
* entry[+].fullUrl = "SubstanceDefinition/substance-infliximab"
* entry[=].resource = substance-infliximab 
 

// AdministrableProductDefinition

* entry[+].fullUrl = "AdministrableProductDefinition/ap-e3e5e78d4e002ed9e15b925cd546e20b"
* entry[=].resource = ap-e3e5e78d4e002ed9e15b925cd546e20b 
 

// RegulatedAuthorization

* entry[+].fullUrl = "RegulatedAuthorization/authorizatione3e5e78d4e002ed9e15b925cd546e20b"
...
* entry[+].fullUrl = "PackagedProductDefinition/ppd-e3e5e78d4e002ed9e15b925cd546e20b"
