...
* id = "d43e3963-bc14-4256-8d95-4c3f1f102144" 
...
* author = Reference(org-marketingauthorisationholder-acmeindustry-paracetamol)
...
* section[+].
  ...
  * code.text = "Product Info"
  ...
  // Ingredient
//  * entry[+].fullUrl = 822117f8-0d40-4881-af02-bed6ce919010
  * entry[+] = Reference(ingredient-for-paracetamol-qqq) 

  // Ingredient
//  * entry[+].fullUrl = 4edd8155-99ed-4c22-b6aa-d696558531b5
  * entry[+] = Reference(ingredient-for-paracetamol-www) 

  // Ingredient
//  * entry[+].fullUrl = 9b936a6a-a403-4ceb-b71f-f2d2354a9d24
  * entry[+] = Reference(ingredient-for-paracetamol-paracetamol) 
 

  // Substance
//  * entry[+].fullUrl = 7e8468ff-c848-4cc4-91fe-306c079feac3
  * entry[+] = Reference(substance-paracetamol) 
 

  // AdministrableProductDefinition
//  * entry[+].fullUrl = ca719992-e779-49e7-bcce-b37dde82709f
  * entry[+] = Reference(ap-paracetamol) 
 

  // RegulatedAuthorization
//  * entry[+].fullUrl = 74754bdc-58c9-41ec-adba-c80abd111ff9
  * entry[+] = Reference(authorizationparacetamol) 
 

  // Organization
//  * entry[+].fullUrl = e3b6f94b-3aab-4dba-8156-c70f3810f3b2
  * entry[+] = Reference(org-marketingauthorisationholder-acmeindustry-paracetamol) 
 

  // PackagedProductDefinition
//  * entry[+].fullUrl = 57288a81-67b6-4aea-8ec7-147f0f770aaf
  * entry[+] = Reference(ppd-parecatamoltabs) 
 

  // MedicinalProductDefinition
//  * entry[+].fullUrl = abdafe81-3319-4f71-a2da-173c4ebbd832
  * entry[+] = Reference(mpparecetamolamn) 
 

  // ManufacturedItemDefinition
//  * entry[+].fullUrl = df08f8ed-f66c-4445-8783-84bb22dc1ffa
  * entry[+] = Reference(mid-paracetamol) 
