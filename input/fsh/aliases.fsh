...
Alias: $edqm-combinedPharmaceuticalDoseForm-cs = http://hl7.org/fhir/uv/ips/ValueSet/medicine-doseform
Alias: $edqm-route-cs = http://hl7.org/fhir/uv/ips/ValueSet/medicine-route-of-administration // Routes and Methods of Administration
