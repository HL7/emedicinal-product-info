...
* entry[=].resource = Inline-Instance-for-gravitate-maria-1

* entry[+].fullUrl = "urn:uuid:c154158f-6a43-4ab7-8443-e7f4bf915dd5" // Patient
* entry[=].resource = Inline-Instance-for-gravitate-maria-2


* entry[+].fullUrl = "urn:uuid:1ece89c5-fda3-4db9-ace6-decbe6c603d8" // Practictioner
* entry[=].resource = Inline-Instance-for-gravitate-maria-3


* entry[+].fullUrl = "urn:uuid:1dff4474-fa08-4f45-8260-dbb23094bf07" // Allergy
* entry[=].resource = gravitate-maria-allergy-1



* entry[+].fullUrl = "urn:uuid:bcc79261-142c-48ec-b032-f3f9af49ec58"
* entry[=].resource = gravitate-maria-condition-1


* entry[+].fullUrl = "urn:uuid:a4a9d90a-d1b0-4d60-82f0-c52343dc6256"
* entry[=].resource = gravitate-maria-condition-2


* entry[+].fullUrl = "urn:uuid:f06b7cf8-c15c-4288-a0f9-45a1026e5130"
* entry[=].resource = gravitate-maria-condition-3


* entry[+].fullUrl = "urn:uuid:29074ca4-efcb-4ff4-8446-feed2399a899"
* entry[=].resource = gravitate-maria-medicationStatement-1



* entry[+].fullUrl = "urn:uuid:f6cb1218-f81c-4338-80d8-3c10910f78fd"
* entry[=].resource = gravitate-maria-medicationStatement-2


* entry[+].fullUrl = "urn:uuid:f26084c9-b1c8-46d9-acb2-1d400ade87ba"
* entry[=].resource = gravitate-maria-medicationStatement-3



* entry[+].fullUrl = "urn:uuid:b50ae644-e0b7-4007-809f-26f493cbe36b"
* entry[=].resource = gravitate-maria-medication-1
* entry[+].fullUrl = "urn:uuid:de131e15-ed13-4b31-b38c-3204a84d99c4"
* entry[=].resource = gravitate-maria-medication-2
* entry[+].fullUrl = "urn:uuid:9ac3356c-4ea4-4814-84c3-235484f2ef19"
* entry[=].resource = gravitate-maria-medication-3


Instance: Inline-Instance-for-gravitate-maria-1
...
* section[=].entry[0] = Reference(urn:uuid:29074ca4-efcb-4ff4-8446-feed2399a899) "Dimethyl fumarate 30 mg Tablet"
...
Instance: Inline-Instance-for-gravitate-maria-2
InstanceOf: Patient
Usage: #inline
...
Instance: Inline-Instance-for-gravitate-maria-3
...
Instance: gravitate-maria-allergy-1
...
Instance: gravitate-maria-condition-1
...
Instance: gravitate-maria-condition-2
InstanceOf: Condition
Usage: #inline
* clinicalStatus = $condition-clinical#active
...
Instance: gravitate-maria-condition-3
InstanceOf: Condition
Usage: #inline
* clinicalStatus = $condition-clinical#active
...
Instance: gravitate-maria-medicationStatement-1
...
Instance: gravitate-maria-medicationStatement-2
InstanceOf: MedicationStatement
Usage: #inline
* status = #active
...
Instance: gravitate-maria-medicationStatement-3
InstanceOf: MedicationStatement
Usage: #inline
* status = #active
...
Instance: gravitate-maria-medication-1
...
Instance: gravitate-maria-medication-2
InstanceOf: Medication
Usage: #inline
...
Instance: gravitate-maria-medication-3
InstanceOf: Medication
Usage: #inline
