Instance: cfsb1639231381772
InstanceOf: PackagedProductDefinition
Description: "blister x100 120 mg"
Usage: #example

* identifier.system = "https://spor.ema.europa.eu/pmswi/#/"
* identifier.value = "EU/1/17/1201/005"
...
* copackagedIndicator = false
 ...
 // Reference to RegulatedAuthorization: EU/1/17/1201/005  100 - 120 mg
* marketingAuthorization = Reference(cfsb1639231013897)
...
* package.identifier.value = "EU/1/17/1201/005"
