Instance: cfsb1639231308548
InstanceOf: PackagedProductDefinition
Description: "blister x210 30 mg"
Usage: #example
...
* containedItemQuantity.value = 210
...
* copackagedIndicator = false
 ...
 // Reference to RegulatedAuthorization: EU/1/17/1201/014 210 - 30 mg
* marketingAuthorization = Reference(cfsb1639231145768)
...
* package.identifier.value = "EU/1/17/1201/014"
