Instance: cfsb1639231329878
InstanceOf: PackagedProductDefinition
Description: "blister x40 120 mg"
Usage: #example
...
* containedItemQuantity.value = 40
...
* copackagedIndicator = false
 ...
 // Reference to RegulatedAuthorization: EU/1/17/1201/002 40 - 120 mg
* marketingAuthorization = Reference(cfsb1639234802176)
...
* package.identifier.value = "EU/1/17/1201/002"
