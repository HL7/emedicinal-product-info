Instance: cfsb1639231397203
InstanceOf: PackagedProductDefinition
Description: "blister x120 120 mg"
Usage: #example
...
* containedItemQuantity.value = 120
...
* copackagedIndicator = false
 ...
 // Reference to RegulatedAuthorization: EU/1/17/1201/006  120 - 120 mg
* marketingAuthorization = Reference(cfsb1639231032998)
...
* package.identifier.value = "EU/1/17/1201/006"
