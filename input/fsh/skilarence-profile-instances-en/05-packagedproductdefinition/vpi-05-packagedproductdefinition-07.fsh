Instance: cfsb1639231412668
InstanceOf: PackagedProductDefinition
Description: "blister x180 120 mg"
Usage: #example

* identifier.system = "https://spor.ema.europa.eu/pmswi/#/"
* identifier.value = "EU/1/17/1201/007"
...
* containedItemQuantity.value = 180
...
* copackagedIndicator = false
 ...
 // Reference to RegulatedAuthorization: EU/1/17/1201/007  180 - 120 mg
* marketingAuthorization = Reference(cfsb1639231046829)
...
* package.identifier.value = "EU/1/17/1201/007"
