Instance: cfsb1639231480623
InstanceOf: PackagedProductDefinition
Description: "blister x400 120 mg"
Usage: #example
...
* containedItemQuantity.value = 400
...
* copackagedIndicator = false
 ...
 // Reference to RegulatedAuthorization: EU/1/17/1201/011 400 - 120 mg
* marketingAuthorization = Reference(cfsb1639231102456)
...
* package.identifier.value = "EU/1/17/1201/011"
