...
// Composition
* entry[+].resource = cfsb5419150199436
...
// authorizations
* entry[+].resource = cfsb9631820498004

// medicinal products
* entry[+].resource = cfsb1151803027115

// packaged product
* entry[+].resource = cfsb2900611666086

// administrable product
* entry[+].resource = cfsb3361388689784

// manufactured items
* entry[+].resource = cfsb6176453266374
