...
| **Type 2** | MedicinalProductDefinition, Organization, PackagedProductDefinition, Ingredient | **Product Identification**: Enables fast lookup in national catalogues and hospital formularies. Supports **Drug Shortage** management and **Allergen** tracking. |
