...
* section[+].
  ...
  * code.text = "Product Info"
  ...
  // Ingredient
  * entry[+] = Reference(cfsb1651162710491) 

  // Ingredient
  * entry[+] = Reference(cfsb1651164758053) 

  // Ingredient
  * entry[+] = Reference(cfsb1651170791283) 

    // Ingredient
  * entry[+] = Reference(cfsb1651229974487) 
    // Ingredient
  * entry[+] = Reference(cfsb1651230170831) 
    // Ingredient
  * entry[+] = Reference(cfsb1651230330246) 

  // AdministrableProductDefinition
  * entry[+] = Reference(cfsb1650999516847) 
 
  // RegulatedAuthorization
  * entry[+] = Reference(cfsb1651148079894) 
 

  // Organization
  * entry[+] = Reference(cfsb1651149636159) 

  // Organization
  * entry[+] = Reference(cfsb1651152112409) 

  // Organization
  * entry[+] = Reference(cfsb1650998521654) 

  // Organization
  * entry[+] = Reference(cfsb1650997423990) 
 
  // PackagedProductDefinition
  * entry[+] = Reference(cfsb1650995718524) 
 
  // MedicinalProductDefinition
  * entry[+] = Reference(cfsb1650904258324) 
...
* entry[=].fullUrl = "Composition/cfsb1651231019151"

// Organizations
* entry[+].resource = cfsb1650997423990
* entry[=].fullUrl = "Organization/cfsb1650997423990"

* entry[+].resource = cfsb1651152112409
* entry[=].fullUrl = "Organization/cfsb1651152112409"
...
* entry[=].fullUrl = "RegulatedAuthorization/cfsb1651148079894"

// medicinal products
* entry[+].resource = cfsb1650904258324
* entry[=].fullUrl = "MedicinalProductDefinition/cfsb1650904258324"

// packaged product
* entry[+].resource = cfsb1650995718524
* entry[=].fullUrl = "PackagedProductDefinition/cfsb1650995718524"

// administrable product
* entry[+].resource = cfsb1650999516847
* entry[=].fullUrl = "AdministrableProductDefinition/cfsb1650999516847"

// manufactured items
* entry[+].resource = cfsb1650998521654
* entry[=].fullUrl = "ManufacturedItemDefinition/cfsb1650998521654"

// ingredients
* entry[+].resource = cfsb1651162710491
* entry[=].fullUrl = "Ingredient/cfsb1651162710491"

* entry[+].resource = cfsb1651164758053
* entry[=].fullUrl = "Ingredient/cfsb1651164758053"

* entry[+].resource = cfsb1651170791283
* entry[=].fullUrl = "Ingredient/cfsb1651170791283"

* entry[+].resource = cfsb1651229974487
* entry[=].fullUrl = "Ingredient/cfsb1651229974487"

* entry[+].resource = cfsb1651230170831
* entry[=].fullUrl = "Ingredient/cfsb1651230170831"

* entry[+].resource = cfsb1651230330246
* entry[=].fullUrl = "Ingredient/cfsb1651230330246"
...
* entry[=].fullUrl = "Composition/cfsb1651234995610"
