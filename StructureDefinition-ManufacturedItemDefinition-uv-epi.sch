...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:ManufacturedItemDefinition/f:identifier</sch:title>
  ...
  <sch:pattern>
    <sch:title>ManufacturedItemDefinition.identifier.extension</sch:title>
    <sch:rule context="f:ManufacturedItemDefinition/f:identifier/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>ManufacturedItemDefinition.identifier.use</sch:title>
    <sch:rule context="f:ManufacturedItemDefinition/f:identifier/f:use">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>ManufacturedItemDefinition.identifier.type</sch:title>
    <sch:rule context="f:ManufacturedItemDefinition/f:identifier/f:type">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>ManufacturedItemDefinition.identifier.system</sch:title>
    <sch:rule context="f:ManufacturedItemDefinition/f:identifier/f:system">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>ManufacturedItemDefinition.identifier.value</sch:title>
    <sch:rule context="f:ManufacturedItemDefinition/f:identifier/f:value">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>ManufacturedItemDefinition.identifier.period</sch:title>
    <sch:rule context="f:ManufacturedItemDefinition/f:identifier/f:period">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>ManufacturedItemDefinition.identifier.assigner</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:ManufacturedItemDefinition/f:property/f:value[x] 1</sch:title>
    <sch:rule context="f:ManufacturedItemDefinition/f:property/f:value[x]">
  ...
  <sch:pattern>
    <sch:title>ManufacturedItemDefinition.property.value[x].extension 1</sch:title>
    <sch:rule context="f:ManufacturedItemDefinition/f:property/f:value[x]/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>ManufacturedItemDefinition.property.value[x].coding 1</sch:title>
    <sch:rule context="f:ManufacturedItemDefinition/f:property/f:value[x]/f:coding">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>ManufacturedItemDefinition.property.value[x].text 1</sch:title>
    <sch:rule context="f:ManufacturedItemDefinition/f:property/f:value[x]/f:text">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
